...
def run(n_target,n_embedding,X_train,X_test,trial):
    ...
    torch.save(model.state_dict(),
               "./vae_models/T%i_E%i_trial%i.pth"%(n_target,n_embedding,trial)
               )
    print("training finished, with starting MSE %1.1e, and ending MSE %1.1e" % (test_losses[0], test_losses[-1]))
